    ...
    <div class="row ">
      <div class="col-lg-8 mx-auto">
        <div class="card col d-flex justify-content-center bg-light" style="width: 80rem;">
            ...
            <div class = "container">
    <form id="contact-form" role="form" method="post" action="{{route('patho')}}" >
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="form_name">Pathologie *</label>
                            <input id="nomP"  type="text" name="nomM" class="form-control" placeholder="..." required="required" data-error="Veuillez saisir la pathologie"  autocomplete="off" >
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input id="id" type="texte" name="codeP" class="form-control" placeholder="" required="required" data-error="">
